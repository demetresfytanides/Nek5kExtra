...
c
      ...
      call get_wssn1(wd,t(1,1,1,1,4),.true.)      
      call get_wssn2(wd,t(1,1,1,1,5),.true.)
      call get_wssn3(wd,t(1,1,1,1,6),.true.)
      ...
      call get_wssn1(wd,t(1,1,1,1,4),.false.)
      call get_wssn2(wd,t(1,1,1,1,5),.false.)
      call get_wssn3(wd,t(1,1,1,1,6),.false.)
...
c==============================================
      subroutine get_wssn3(wd,phi,ifelem)
      include 'SIZE'
      include 'TOTAL'
C
...
c==============================================
      subroutine get_wssn2(wd,phi,ifelem)
      include 'SIZE'
      include 'TOTAL'
C
C     Computes wall-shear stress
...
c===============================================
      subroutine get_wssn1(wd,phi,ifelem)
      include 'SIZE'
      include 'TOTAL'
C
C     Computes wall-shear stress
